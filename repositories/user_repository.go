...
func (r *gormUserRepository) Create(ctx context.Context, username, passwordHash string) error {
...
func (r *gormUserRepository) GetByID(ctx context.Context, userID int) (*models.User, error) {
	var user models.User
